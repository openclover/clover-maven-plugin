...
public class TestUtil {
    ...
    public static void setPrivateParentField(final Class<?> clazz, final Object target, final String fieldName, final Object value) {
        try {
     ...
     */
    public static class RecordingLogger extends SystemStreamLog {
        ...
        public void debug(CharSequence content, Throwable error) {
            super.debug(content);
            buffer.add(new TestUtil.LogEvent(content.toString(), error, Level.DEBUG));
        }
        ...
        public void info(CharSequence content) {
            super.info(content);
            buffer.add(new TestUtil.LogEvent(content.toString(), null, Level.INFO));
        }
        ...
        public void info(CharSequence content, Throwable error) {
            ...
            buffer.add(new TestUtil.LogEvent(content.toString(), error, Level.INFO));
        }

        public void info(Throwable error) {
            super.info(error);
            buffer.add(new TestUtil.LogEvent(null, error, Level.INFO));
        }
        ...
        public void warn(CharSequence content, Throwable error) {
            ...
            buffer.add(new TestUtil.LogEvent(content.toString(), error, Level.WARN));
        }

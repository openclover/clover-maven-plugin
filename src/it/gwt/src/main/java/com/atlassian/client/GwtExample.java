...
public class GwtExample implements EntryPoint {
    ...
    // All widgets which we want to access during unit-testing via gwt-test-utils framework
    // must accessible (e.g. be declared as class fields with at least package visibility or have
    // proper getters).
    Button sendButton;
    TextBox nameField;
    Label errorLabel;
